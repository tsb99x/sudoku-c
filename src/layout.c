...
static SDL_Rect layout_calc_drawable_space(SDL_Rect *screen_space)
{
        SDL_Rect canvas;
...
static SDL_Rect layout_add_padding(SDL_Rect *canvas,
                                   percent_t padding)
{
        SDL_Rect padded;
...
static SDL_Point layout_find_timer_pos(SDL_Rect *canvas,
                                       percent_t timer_size,
                                       percent_t timer_pad)
{
        SDL_Point timer_pos;
...
static SDL_Rect layout_compensate_timer(SDL_Rect *canvas,
                                        percent_t timer_size,
                                        percent_t timer_pad)
{
        SDL_Rect field;
...
static int layout_find_button_size(SDL_Rect *canvas,
...
layout_t *layout_create(percent_t small_gap,
                        percent_t large_gap,
                        percent_t screen_pad,
                        percent_t timer_size,
                        percent_t timer_pad)
...
void layout_destroy(layout_t *self)
{
        free(self);
}

void layout_calc(layout_t *self,
                 SDL_Rect *screen)
{
        SDL_Rect canvas;
        ...
        self->timer_pos =
            layout_find_timer_pos(&canvas, self->timer_size, self->timer_pad);
        canvas =
            layout_compensate_timer(&canvas, self->timer_size, self->timer_pad);
        self->button_canvas = canvas;
        self->button_size =
            layout_find_button_size(&canvas, self->small_gap, self->large_gap);
}

static int calc_gap(int i,
                    int sg,
                    int lg)
{
...
SDL_Rect layout_get_button_rect(layout_t *self,
                                int x,
                                int y)
{
        SDL_Rect rect;
...
SDL_Point layout_get_timer_pos(layout_t *self)
{
        return self->timer_pos;
}

int layout_get_timer_height(layout_t *self)
{
